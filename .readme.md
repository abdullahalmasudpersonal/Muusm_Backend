...
python manage.py wait_for_db && python manage.py runserver -> for linux
python manage.py wait_for_db; python manage.py runserver -> for power shell
...
Django যখন PostgreSQL ব্যবহার করে, তখন ড্রাইভার লাগেই, ড্রাইভার ছাড়া DB connect করা সম্ভব না।
